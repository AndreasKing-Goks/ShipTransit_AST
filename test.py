...
from simulator.controllers import ThrottleControllerGains, HeadingControllerGains, EngineThrottleFromSpeedSetPoint, HeadingByRouteController
...
while ship_model.int.time < ship_model.int.sim_time:
    ...
    ## Get state to obtain reward
    # v_shaft = ship_model.simulation_results[...][ship_model.int.time]
    # e_los = ship_model.simulation_results[...][ship_model.int.time]
    # power_e = ship_model.simulation_results['power electrical [kw]'][ship_model.int.time]
    # av_power_e = ship_model.simulation_results['available power electrical [kw]'][ship_model.int.time]
    
    # Reward = RewardFunction(v_shaft, e_los, power_e, av_power_e)
    
    # DO SAC
    # output trained policy ... [ON PROGRESS]
