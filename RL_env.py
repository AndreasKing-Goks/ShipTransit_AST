...
class ShipRLEnv(Env):
    ...
    # def __init__(self):
        ...
        self.action_space = Box(
            ...
            high = np.array([200, 200, 10], dtype=np.float32),
        )
    ...
    def step(self, action, sample_flag):       
        ...
        reward, done = reward_function(pos, heading_error, measured_shaft_rpm, los_ct_error, engine_load, av_engine_load, self.obstacles)
